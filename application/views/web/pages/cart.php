...
<div class="main">
    <div class="content">
        <div class="cartoption">		
            ...
            <div class="shopping paddingnew">
                <div class="shopleft">
                    <a href="<?php echo base_url('product') ?>" class="check-btn">Continue Shopping
                        <!-- <img src="<?php echo base_url() ?>assets/web/images/shop.png" alt="" /> -->
                        <!-- <button type="button" class="check-btn">Continue Shopping</button> -->
                    </a>
                </div>
                <div class="shopright">
                    <?php
                    ...
                    if (empty($customer_id)) {
                        ...
                        ?>
                        <a href = "<?php echo base_url('customer/shipping') ?>" class="check-btn">Checkout
                            <!-- <img src = "<?php echo base_url() ?>assets/web/images/check.png" alt = "" /> -->
                        </a>
                        <?php
                    }
                    ?>
