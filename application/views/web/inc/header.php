...
<body>
	<div class="wrap">
		<div class="header_top">
			<div class="logo">
				<a href="<?php echo base_url('/'); ?>"><img style="height: 100px;" src="<?php echo base_url('uploads/'); ?><?php echo get_option('site_logo'); ?>" alt="" /></a>
			</div>
			<div class="header_top_right">
				...
				if ($customer_id) {
				?>
					<div class="mt-2"><a class="btnmain ml-2" href="<?php echo base_url('/customer/logout'); ?>">Logout</a></div>
				<?php } else {
				?>
					<div class="mt-2"><a class="btnmain ml-2" href="<?php echo base_url('/customer/login'); ?>">Login</a></div>
		...
		<div class="menu">
			<ul id="dc_mega-menu-orange" style="float:left" class="dc_mm-orange">
				...
				<?php if ($this->session->userdata('customer_id')) { ?>
					<li class="<?php
								if ($this->uri->uri_string() == 'user/userinfo') {
									echo "active";
								}
								?>">
								
					<a href="<?php echo base_url('/user/userinfo'); ?>">My Account</a></li>
